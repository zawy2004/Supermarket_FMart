                                        ...
                                        <form>
                                            ...
                                            <div class="form-group text-center">
                                                ...
                                                <div class="social-login">
                                                    <a href="https://accounts.google.com/o/oauth2/auth?scope=email%20profile&redirect_uri=http://localhost:8080/Supermarket_FMart/User/login-google&response_type=code&client_id=549548859496-abt5dfb1krnhv8lc1vnblaf92tojn0eh.apps.googleusercontent.com" class="social-btn google-btn">
                                                        <div class="icon"><i class="fab fa-google"></i></div>
                                                        <span>Google</span>
                                                    </a>
                                                    <a href="https://www.facebook.com/v12.0/dialog/oauth?client_id=YOUR_APP_ID&redirect_uri=http://localhost:8080/Supermarket_FMart/User/login-facebook&scope=email" class="social-btn facebook-btn">
