            ...
            <jsp:include page="footer.jsp"></jsp:include>
                ...
                <script>
                                                                            ...
                                                                            function updateQuantityFromInput() {
                                                                                ...
                                                                                if (newValue < 1)
                                                                                    newValue = 1;
                                                                                if (newValue > ${product.minStockLevel})
                                                                                    newValue = ${product.minStockLevel}; // Giới hạn theo tồn kho
                                                                            ...
                                                                            $(document).on("click", "#wishlist-icon", function () {
                                                                                ...
                                                                                isUserLoggedIn(function (loggedIn) {
                                                                                    if (!loggedIn) {
                                                                                        showNotification('Please log in to add to wishlist!', 'danger');
                                                                                        window.location.href = 'login';
                                                                                        return;
                                                                                    }
                                                                                    ...
                                                                                    $.ajax({
                                                                                        ...
                                                                                        error: function (xhr) {
                                                                                            showNotification("Error updating wishlist: " + xhr.responseText, "danger");
                                                                                        }
                                                                                    });
                                                                                });
                                                                            });
