...
<head>
    ...
    <meta name="description" content="FMart Blog - Detail with Left Sidebar">
    <meta name="author" content="FMartlthemes">
    <title>FMart - Blog Detail with Sidebar: ${blog.title}</title>
                    ...
                    <div class="col-lg-8 col-md-7">
                        <div class="blog-detail">
                            ...
                            <c:if test="${not empty blog}">
                                ...
                                <img src="User/images/blog/${blog.image}" alt="${blog.title}" class="blog-img" onerror="this.src='User/images/blog/no-image.jpg'">
