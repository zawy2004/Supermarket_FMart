...
<html lang="en">
    ...
    <!-- Mirrored from gambolthemes.net/html-items/gambo_supermarket_demo_new/request_product.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Jun 2025 12:01:20 GMT -->
    <head>
        <meta charset="utf-8">
        ...
        <title>FMart - Request Product</title>
        ...
        <link href="User/css/bootstrap-tagsinput.css" rel="stylesheet">
    ...
    <body>
        ...
        <!-- Header Start -->
      <jsp:include page="header.jsp"></jsp:include>        <!-- Header End -->
        <!-- Body Start -->
        <div class="wrapper">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="default-title">
                                ...
                                <p>How Do I order for Request on FMart</p>
                                <img src="images/line.svg" alt="">
                            </div>
                        </div>
  ...
  <jsp:include page="footer.jsp"></jsp:include>
        ...
        <script src="User/js/bootstrap-tagsinput.min.js"></script>
