    ...
    <body>	
                                    ...
                                    <div class="product-item mb-30">
                                        <a href="single_product?productId=${product.productID}" class="product-img">
                                            ...
                                            <div class="product-absolute-options">
                                                ...
                                                <span 
                                                    class="like-icon wishlist-btn ${product.isWishlisted ? 'active' : ''}" 
        ...
        <script>
            $(document).on("click", ".wishlist-btn", function () {
                ...
                const isWishlisted = $icon.hasClass("active");

                $.post(
                        "${pageContext.request.contextPath}/wishlist",
                        {
                    ...
                    if (xhr.status === 401) {
                        ...
                        showNotification("Server error, try again!", "danger");
                    }
                });
            });
        </script>
