                    ...
                    <div class="category-model-content modal-content"> 
                        ...
                        <ul class="category-by-cat">
                            <c:forEach var="cat" items="${categories}">
                                <li>
                                    <a href="shop_grid?cat=${cat.categoryID}" class="single-cat-item">
                                        <div class="icon">
                                            <img src="${cat.imageUrl != null ? cat.imageUrl : 'User/images/category/icon-1.svg'}" alt="">
                                        </div>
                                    ...
                                    <div class="item">
                                        <div class="offer-item">								
                                            ...
                                            <div class="offer-text-dt">
                                                ...
                                                <a href="User/shop_grid" class="Offer-shop-btn hover-btn">Shop Now</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="item">
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <c:forEach var="cat" items="${categories}">
                                    <div class="item">
                                        <a href="shop_grid?cat=${cat.categoryID}" class="category-item">
                                            <div class="cate-img">
                                                <img src="${cat.imageUrl != null ? cat.imageUrl : 'User/images/category/icon-1.svg'}" alt="">
                                            </div>
            ...
            <div class="section145">
                <div class="container">
                    <div class="main-title-tt">
                        ...
                        <a href="shop_grid" class="see-more-btn">See All</a>
                    </div>
                    <div class="owl-carousel featured-slider owl-theme">
                        <c:forEach var="product" items="${featuredProducts}">
                            <div class="item">
                                <div class="product-item">
                                    <a href="single_product_view.jsp?id=${product.productID}" class="product-img">
                                    ...
                                    <div class="product-text-dt">
                                        ...
                                        <div class="product-price">
                                            ...
                                            <c:if test="${product.oldPrice > product.sellingPrice}">
                        ...
                        <c:if test="${empty featuredProducts}">
                            <div class="item"><p>No featured products.</p></div>
                        </c:if>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="main-title-tt">
                                ...
                                <a href="User/shop_grid" class="see-more-btn">See All</a>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="owl-carousel featured-slider owl-theme">
