...
<html lang="en">
    ...
    <!-- Mirrored from gambolthemes.net/html-items/gambo_supermarket_demo_new/dashboard_my_wishlist.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Jun 2025 12:01:12 GMT -->
    <head>
        <meta charset="utf-8">
    ...
    <body>
       ...
       <jsp:include page="header.jsp"></jsp:include>
        ...
        <!-- Body End -->
        <!-- Footer Start -->
    <jsp:include page="footer.jsp"></jsp:include>SS
        <!-- Footer End -->
    ...
    <!-- Mirrored from gambolthemes.net/html-items/gambo_supermarket_demo_new/dashboard_my_wishlist.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Jun 2025 12:01:13 GMT -->
</html>