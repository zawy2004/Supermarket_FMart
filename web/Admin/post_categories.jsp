...
<!-- Mirrored from gambolthemes.net/html-items/gambo_admin_new/post_categories.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Jun 2025 12:09:58 GMT -->
<head>
	<meta charset="utf-8">
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse show" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
									...
									<a class="nav-link sub_nav_link active" href="post_categories.jsp">Categories</a>
														...
														<table class="table ucp-table table-hover">
															...
															<tbody>
																<tr>
																	...
																	<td>
																		<a href="#" target="_blank">Food &amp; Lifestyle</a>
																	</td>
																	<td>food-and-lifestyle</td>
																	<td>
																		<span class="delivery-time">20/06/2020</span>
																	</td>
																</tr>
																<tr>
																	<td><input type="checkbox" class="check-item" name="ids[]" value="5"></td>
																	<td>
																		<a href="#" target="_blank">Uncategory</a>
																	</td>
																	<td>uncategory</td>
																	<td>
																		<span class="delivery-time">20/06/2020</span>
																...
																<tr>
																	<td><input type="checkbox" class="check-item" name="ids[]" value="5"></td>
																	<td>
																		<a href="#" target="_blank">Body Care</a>
																	</td>
																	<td>body-care</td>
																	<td>
																		<span class="delivery-time">20/06/2020</span>
																...
																<tr>
																	<td><input type="checkbox" class="check-item" name="ids[]" value="5"></td>
																	<td>
																		<a href="#" target="_blank">Food News</a>
																	</td>
																	<td>food-news</td>
																	<td>
																		<span class="delivery-time">20/06/2020</span>
