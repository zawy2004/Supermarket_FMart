                                ...
                                <form action="CategoryServlet" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="parentCategoryID" class="form-control" 
                                               value="<%= category.getParentCategoryID()==0? "" : category.getParentCategoryID()%>"
                                               min="0" 
                                               <% if (category.getParentCategoryID() == category.getCategoryID()) { %> style="border: 1px solid red;" <% } %>>
                                        <% if (category.getParentCategoryID() == category.getCategoryID()) { %>
                                            <div class="alert alert-danger mt-2">Parent category cannot be itself!</div>
                                        <% } %>
                                    </div>
                                    <div class="form-group">
