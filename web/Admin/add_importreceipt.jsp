...
<%@ page import="model.ImportReceipt, model.Warehouse, model.Supplier" %>
<%@ page import="dao.ImportReceiptDAO, dao.WarehouseDAO, dao.SupplierDAO" %>
                ...
                <div id="layoutSidenav_content">
                    <main>
                        <div class="container-fluid">
                            <h2 class="mt-30 page-title">Add New Import Receipt</h2>
                            <ol class="breadcrumb mb-30">
                                <li class="breadcrumb-item"><a href="importReceiptList.jsp">Import Receipts</a></li>
                                <li class="breadcrumb-item active">Add Import Receipt</li>
                            </ol>
                            <div class="row">
                                <div class="col-xl-10 col-md-12">
                                    <div class="card card-static-2 mb-30">
                                        <div class="card-body-table">
                                            <form action="ImportReceiptServlet" method="post">
                                            ...
                                            <button type="submit" class="btn btn-success">Add Import Receipt</button>
                                            <a href="ImportReceiptServlet" class="btn btn-secondary">Cancel</a>
                                        </form>
                                    </div>
                                </div>
                            </div>
