...
<!-- Mirrored from gambolthemes.net/html-items/gambo_admin_new/add_location.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Jun 2025 12:09:58 GMT -->
<head>
	<meta charset="utf-8">
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse show" id="collapseLocations" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
									...
									<a class="nav-link sub_nav_link active" href="add_location.jsp">Add Location</a>
								</nav>
                            </div>		
                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-30">
                            ...
                            <li class="breadcrumb-item"><a href="locations.jsp">Locations</a></li>
