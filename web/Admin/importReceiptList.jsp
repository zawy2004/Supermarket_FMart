                                ...
                                <div class="card card-static-2 mb-30">
                                    ...
                                    <div class="card-body-table">
                                        <div class="table-responsive">
                                            ...
                                            <%-- Xây query an toàn với escapeXml --%>
                                            <c:set var="queryStr">
                                            ...
                                            <nav aria-label="Page navigation" class="mt-4">
                                                <ul class="pagination justify-content-center">
                                                    ...
                                                    <li class="page-item ${page == 1 ? 'disabled' : ''}">
                                                        <a class="page-link" href="ImportReceiptServlet?page=${page - 1}&${queryStr}">Previous</a>
                                                    </li>
                                                    ...
                                                    <li class="page-item ${page == totalPages || totalPages == 0 ? 'disabled' : ''}">
                                                        <a class="page-link" href="ImportReceiptServlet?page=${page + 1}&${queryStr}">Next</a>
                                                    </li>
                                                </ul>
                                            </nav>
