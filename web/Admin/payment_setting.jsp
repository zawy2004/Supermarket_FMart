...
<!-- Mirrored from gambolthemes.net/html-items/gambo_admin_new/payment_setting.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Jun 2025 12:10:12 GMT -->
<head>
	<meta charset="utf-8">
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse show" id="collapseSettings" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
									...
									<a class="nav-link sub_nav_link active" href="payment_setting.jsp">Payment Settings</a>
							...
							<div class="col-lg-4 col-md-6">
								<div class="left-side-tabs">
									<div class="dashboard-left-links">
										<a href="payment_setting.jsp" class="user-item active"><i class="fab fa-paypal"></i>Paypal</a>
										<a href="payment_setting_stripe.jsp" class="user-item"><i class="fab fa-stripe"></i>Stripe</a>
									</div>
								</div>
							</div>
											...
											<div class="row">
												<div class="col-lg-12">
													...
													<div class="form-group">
														...
														<input type="email" class="form-control" value="gambol943@gmail.com" placeholder="Enter paypal email">
													</div>
