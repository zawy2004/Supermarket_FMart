...
<!-- Mirrored from gambolthemes.net/html-items/gambo_admin_new/edit_profile.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Jun 2025 12:09:58 GMT -->
<head>
	<meta charset="utf-8">
										...
										<div class="shopowner-content-left text-center pd-20">
											...
											<div class="shopowner-dts">
												...
												<div class="shopowner-dt-list">
													...
													<span class="right-dt">Fmart@gmail.com</span>
												</div>
												<div class="shopowner-dt-list">
											...
											<div class="row">
												...
												<div class="col-lg-6">
													<div class="form-group mb-3">
														...
														<input type="email" class="form-control" value="Fmart@gmail.com" placeholder="Enter Email Address">
													</div>
												</div>
												<div class="col-lg-6">
													<div class="form-group mb-3">
                ...
                <footer class="py-4 bg-footer mt-auto">
                    <div class="container-fluid">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted-1">© 2024 <b>FMart Supermarket</b>. by <a href="https://themeforest.net/user/gambolthemes">FMartlthemes</a></div>
