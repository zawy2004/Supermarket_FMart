...
<!-- Mirrored from gambolthemes.net/html-items/gambo_admin_new/locations.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Jun 2025 12:09:58 GMT -->
<head>
	<meta charset="utf-8">
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
							...
							<a class="nav-link active" href="#" data-bs-toggle="collapse" data-bs-target="#collapseLocations" aria-expanded="true" aria-controls="collapseLocations">
								<div class="sb-nav-link-icon"><i class="fas fa-map-marker-alt"></i></div>
                                Locations
                                <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
							</a>
                            <div class="collapse show" id="collapseLocations" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
									<a class="nav-link sub_nav_link active" href="locations.jsp">All Locations</a>
                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <div class="row justify-content-between">
							<div class="col-lg-12">
								<a href="add_location.jsp" class="add-btn hover-btn">Add New</a>
							</div>
							...
							<div class="col-lg-5 col-md-6">
								<div class="bulk-section mt-30">
									...
									<div class="input-group">
										...
										<div class="input-group-append">
											<button class="status-btn hover-btn" type="submit">Search Location</button>
										</div>
									</div>
								</div>
							</div>
