...
<!-- Mirrored from gambolthemes.net/html-items/gambo_admin_new/products.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Jun 2025 12:10:02 GMT -->
<head>
	<meta charset="utf-8">
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
							...
							<a class="nav-link active" href="#" data-bs-toggle="collapse" data-bs-target="#collapseProducts" aria-expanded="true" aria-controls="collapseProducts">
                            ...
                            <div class="collapse show" id="collapseProducts" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
									<a class="nav-link sub_nav_link active" href="products.jsp">All Products</a>
												...
												<tbody>
													<tr>
														...
														<td class="action-btns">
															<a href="product_view.jsp" class="view-shop-btn" title="View"><i class="fas fa-eye"></i></a>
...
<!-- Mirrored from gambolthemes.net/html-items/gambo_admin_new/products.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Jun 2025 12:10:05 GMT -->
</html>
