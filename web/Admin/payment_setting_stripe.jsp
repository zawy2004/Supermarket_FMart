...
<!-- Mirrored from gambolthemes.net/html-items/gambo_admin_new/payment_setting_stripe.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Jun 2025 12:10:15 GMT -->
<head>
	<meta charset="utf-8">
							...
							<div class="col-lg-4 col-md-6">
								<div class="left-side-tabs">
									<div class="dashboard-left-links">
										<a href="payment_setting.jsp" class="user-item"><i class="fab fa-paypal"></i>Paypal</a>
										<a href="payment_setting_stripe.jsp" class="user-item active"><i class="fab fa-stripe"></i>Stripe</a>
									</div>
								</div>
							</div>
