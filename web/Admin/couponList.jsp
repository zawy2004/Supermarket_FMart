...
<!-- Mirrored from gambolthemes.net/html-items/gambo_admin_new/couponList.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Jun 2025 12:10:07 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <title>FMart Supermarket Admin - Danh sách mã giảm giá</title>
    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                <h2 class="mt-30 page-title">Danh sách mã giảm giá</h2>
                            ...
                            <div class="card-body-table">
                                <div class="table-responsive">
                                    <table class="table ucp-table table-hover">
                                        ...
                                        <tbody>
                                        <% ResultSet rs = (ResultSet) request.getAttribute("coupons");
                                            while (rs != null && rs.next()) { %>
                                        <tr>
                                            <td><%= rs.getString("CouponCode") %></td>
                                            <td><%= rs.getString("CouponName") %></td>
                                            <td><%= rs.getString("DiscountType") %></td>
                                            <td><%= rs.getDouble("DiscountValue") %> <%= rs.getString("DiscountType").equals("Percentage") ? "%" : "VND" %></td>
                                            <td><%= rs.getInt("UsageCount") %></td>
                                            <td><%= rs.getInt("UsageLimit") %></td>
                                            <td>
                                                <a href="${pageContext.request.contextPath}/coupon.jsp?couponId=<%= rs.getInt("CouponID") %>" class="edit-btn"><i class="fas fa-edit"></i></a>
                                            </td>
                                        </tr>
                                        <% } %>
                                        </tbody>
                ...
                <a href="${pageContext.request.contextPath}/coupon.jsp" class="btn btn-primary mt-3">Tạo mã giảm giá mới</a>
            </div>
        </main>
