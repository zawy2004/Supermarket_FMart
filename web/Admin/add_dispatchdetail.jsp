...
<head>
    <meta charset="UTF-8">
    <title>Add Product to Dispatch Receipt</title>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    <h2 class="mt-30 page-title">Add Product to Dispatch Receipt</h2>
                    <ol class="breadcrumb mb-30">
                        <li class="breadcrumb-item"><a href="DispatchReceiptServlet">Dispatch Receipts</a></li>
                        <li class="breadcrumb-item"><a href="DispatchDetailServlet?dispatchID=${dispatchID}">Dispatch Details</a></li>
                        ...
                        <div class="col-xl-10 col-md-12">
                            <div class="card card-static-2 mb-30">
                                <div class="card-body-table">
                                    <form action="DispatchDetailServlet" method="post">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="number" step="0.01" name="unitCost" id="unitCost" class="form-control" min="0" required>
                                        </div>
                                        ...
                                        <a href="DispatchDetailServlet?dispatchID=${dispatchID}" class="btn btn-secondary">Cancel</a>
                                    </form>
                                </div>
                            </div>
                        </div>
