...
<!-- Mirrored from gambolthemes.net/html-items/gambo_admin_new/login.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Jun 2025 12:09:58 GMT -->
<head>
	<meta charset="utf-8">
                                    ...
                                    <div class="card-body">
                                        <form>
                                            ...
                                            <div class="form-group d-flex align-items-center justify-content-between mt-4 mb-0">
												<a class="btn btn-sign hover-btn" href="index.jsp">Login</a>
											</div>
                                        </form>
                                    </div>
                                </div>
