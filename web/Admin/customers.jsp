												...
												<tbody>
													<tr>
														...
														<td class="action-btns">
															<a href="customer_view.jsp" class="view-shop-btn" title="View"><i class="fas fa-eye"></i></a>
															<a href="customer_edit.jsp" class="edit-btn" title="Edit"><i class="fas fa-edit"></i></a>
