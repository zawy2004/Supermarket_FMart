...
<!-- Mirrored from gambolthemes.net/html-items/gambo_admin_new/add_menu.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Jun 2025 12:10:14 GMT -->
<head>
	<meta charset="utf-8">
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link active" href="menu.jsp">
											...
											<div class="panel-heading" role="tab" id="headingfive">
												<div class="panel-title">
													<a class="collapsed" data-bs-toggle="collapse" data-bs-parent="#accordion" href="#collapsefive" aria-expanded="false" aria-controls="collapsefive">
														<i class="uil uil-check chck_icon"></i>Blog
													</a>
												</div>
											</div>
														...
														<div class="panel panel-default-1">
															<div class="panel-heading-1" role="tab" id="menu-1">
																<div class="panel-title-1">
																	<a data-bs-toggle="collapse" data-bs-parent="#accordion" href="#collapseMenuOne" aria-expanded="true" aria-controls="collapseMenuOne">	
																	...
																	<div class="row">
																		...
																		<div class="col-lg-12">
																			<div class="bb-bottom">
																				...
																				<span class="attr-orgin-right">Origin: <a target="_blank">Page</a></span>
																			</div>
																		</div>
																	</div>
																</div>
