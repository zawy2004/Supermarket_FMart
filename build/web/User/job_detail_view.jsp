...
<!-- Mirrored from gambolthemes.net/html-items/gambo_supermarket_demo_new/job_detail_view.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Jun 2025 12:01:20 GMT -->
<head>
		<meta charset="utf-8">
		...
		<title>FMart - Job Detail View</title>
...
<body>
	...
	<div id="apply_job_model" class="header-cate-model main-gambo-model modal fade" tabindex="-1" role="dialog" aria-modal="false">
        <div class="modal-dialog category-area modal-lg" role="document">
            <div class="category-area-inner">
                ...
                <div class="category-model-content modal-content"> 
					<div class="cate-header">
						<h4>Express Interest for Working at FMart</h4>
					</div>
									...
									<form class="">
										<div class="address-fieldset">
											<div class="row">
												...
												<div class="col-lg-6">
													<div class="form-group mt-30">
														<div class="control-label">Upload your CV or Resume File*</div>
														<div class="input-group">
															<div class="custom-file">
																<input type="file" class="custom-file-input" id="inputGroupFile04">
																<label class="custom-file-label" for="inputGroupFile04">PDF files (Max Size: 500KB)</label>
															</div>
														</div>
													</div>
												</div>
												...
												<div class="col-lg-12">
													<h4 class="ques-142 mt-30">Questions</h4>
												</div>
												<div class="col-lg-6">
													<div class="form-group mt-30">
														<label class="control-label">Which city are you currently in?*</label>
														<div class="ui search focus">
															<div class="ui left icon input swdh11 swdh19">
																<input class="prompt srch_explore" type="text" name="question1" value="" id="question[1]" required="" placeholder="Enter Answer">															
															</div>
														</div>
													</div>
												</div>
												<div class="col-lg-6">
													<div class="form-group mt-30">
														<label class="control-label">How many years of relevant experience do you have?*</label>
														<div class="ui search focus">
															<div class="ui left icon input swdh11 swdh19">
																<input class="prompt srch_explore" type="text" name="question2" value="" id="question[2]" required="" placeholder="Enter Answer">															
															</div>
														</div>
													</div>
												</div>
												<div class="col-lg-6">
													<div class="form-group mt-30">
														<label class="control-label">Which company are you currently working with?*</label>
														<div class="ui search focus">
															<div class="ui left icon input swdh11 swdh19">
																<input class="prompt srch_explore" type="text" name="question3" value="" id="question[3]" required="" placeholder="Enter Answer">															
															</div>
														</div>
													</div>
												</div>
												<div class="col-lg-6">
													<div class="form-group mt-30">
														<label class="control-label">What is your current compensation?*</label>
														<div class="ui search focus">
															<div class="ui left icon input swdh11 swdh19">
																<input class="prompt srch_explore" type="text" name="question4" value="" id="question[4]" required="" placeholder="Enter Answer">															
															</div>
														</div>
													</div>
												</div>
												<div class="col-lg-12">
													<div class="form-group mt-30">
														<label class="control-label">Which institute have you done your engineering from (Under graduation)?*</label>
														<div class="ui search focus">
															<div class="ui left icon input swdh11 swdh19">
																<input class="prompt srch_explore" type="text" name="question5" value="" id="question[5]" required="" placeholder="Enter Answer">															
															</div>
														</div>
													</div>
												</div>
												<div class="col-lg-12">
													<div class="ui form mt-30 mb-4">
														<div class="required inline field">
															<div class="form-check">
																<input class="form-check-input" type="checkbox" value="" id="flexCheckDefault">
																<label class="form-check-label" for="flexCheckDefault">
																	I have read and agree with the Applicant Privacy Policy of FMart.
																</label>
															</div>															
														</div>
													</div>
												...
												<div class="col-lg-12 col-md-12">
													<div class="form-group mb-0 mt-2">
														<div class="address-btns">
															<button class="save-btn14 hover-btn" type="submit">Submit Application</button>
														</div>
													</div>
												</div>
											</div>
					...
					<div class="col-md-12">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><a href="career.jsp">Career</a></li>
								<li class="breadcrumb-item active" aria-current="page">Software Development Engineer</li>
							</ol>
						</nav>
					</div>
				</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-12 col-md-12">
						...
						<div class="job-des-dt142">
							<h4>Here's what you'll do day-to-day</h4>
						...
						<div class="job-req-dt">
							<h3>Job Requirements</h3>
						</div>
						<div class="job-des-dt142">
							<h4>Who fits the bill?</h4>
							<ul class="joby-list-dt">
								<li><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p></li>
								<li><p>Sed ut dui et tellus euismod accumsan.</p></li>
								<li><p>Aenean sed neque vitae nisi commodo ultricies sed ut sapien.</p></li>
						...
						<button class="apply-btn hover-btn" data-bs-toggle="modal" data-bs-target="#apply_job_model">Apply Now</button>
					</div>
				</div>
			</div>
		</div>	
