...
<!-- Mirrored from gambolthemes.net/html-items/gambo_supermarket_demo_new/press.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Jun 2025 12:01:45 GMT -->
<head>
		<meta charset="utf-8">
						...
						<div class="default_tabs">
							<nav>
								<div class="nav nav-tabs tab_default  justify-content-center">
									...
									<a class="nav-item nav-link active" href="press.jsp">Press</a>
								</div>
							</nav>						
						</div>
						<div class="title129">	
				...
				<div class="row">
					...
					<div class="col-lg-8 col-md-12">
						<div class="press-title">
							<h2>FMart in the News</h2>
							<p>For media interviews and inquiries, please send an email to <a href="#">press@FMartsupermarket.com</a></p>
						</div>
						<a href="#" class="press-item">
							<span>May 15, 2020</span>
							<h4>Live Mint</h4>
							<p>FMart delivery the goods</p>
						</a>
						<a href="#" class="press-item">
							<span>May 12, 2020</span>
							<h4>Business Standred</h4>
							<p>FMart targets $20 million revenue in 2020</p>
						</a>
						<a href="#" class="press-item">
							<span>May 8, 2020</span>
							<h4>Tech Asia</h4>
							<p>FMart’s secret to handling 5,000 orders a day</p>
						</a>
						<a href="#" class="press-item">
							<span>May 5, 2020</span>
							<h4>Your Story</h4>
							<p>Ludhiana-based online grocery firm FMart is set to create an organic revolution in india</p>
						</a>
					</div>
				</div>
			</div>
