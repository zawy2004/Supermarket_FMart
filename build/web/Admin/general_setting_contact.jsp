...
<!-- Mirrored from gambolthemes.net/html-items/gambo_admin_new/general_setting_contact.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Jun 2025 12:10:15 GMT -->
<head>
	<meta charset="utf-8">
							...
							<div class="col-lg-4 col-md-6">
								<div class="left-side-tabs">
									<div class="dashboard-left-links">
										...
										<a href="general_setting_contact.jsp" class="user-item active"><i class="fas fa-briefcase"></i>Contact Setting</a>
									</div>
								</div>
							</div>
											...
											<div class="row">
												<div class="col-lg-12">
													<div class="form-group">
														...
														<input type="text" type="text" value="Fmartsupermarket@example.com" class="form-control" placeholder="Email">
													</div>
													<div class="form-group">
