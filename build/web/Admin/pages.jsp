...
<!-- Mirrored from gambolthemes.net/html-items/gambo_admin_new/pages.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Jun 2025 12:10:10 GMT -->
<head>
	<meta charset="utf-8">
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
							...
							<a class="nav-link active" href="pages.jsp">
                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <div class="row justify-content-between">
							<div class="col-lg-12">
								<a href="add_page.jsp" class="add-btn hover-btn">Add New Page</a>
							</div>
							...
							<div class="col-lg-5 col-md-6">
								<div class="bulk-section mt-30">
									...
									<div class="input-group">
										...
										<div class="input-group-append">
											<button class="status-btn hover-btn" type="submit">Search Page</button>
										</div>
									</div>
								</div>
							</div>
