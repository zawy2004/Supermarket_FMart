...
<!-- Mirrored from gambolthemes.net/html-items/gambo_admin_new/areas.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Jun 2025 12:09:58 GMT -->
<head>
	<meta charset="utf-8">
                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <div class="collapse show" id="collapseAreas" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
									<a class="nav-link sub_nav_link active" href="areas.jsp">All Areas</a>
                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <div class="row justify-content-between">
							<div class="col-lg-12">
								<a href="add_area.jsp" class="add-btn hover-btn">Add New</a>
							</div>
