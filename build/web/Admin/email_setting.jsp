...
<!-- Mirrored from gambolthemes.net/html-items/gambo_admin_new/email_setting.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Jun 2025 12:10:12 GMT -->
<head>
	<meta charset="utf-8">
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse show" id="collapseSettings" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
									...
									<a class="nav-link sub_nav_link active" href="email_setting.jsp">Email Settings</a>
								</nav>
                            </div>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h2 class="mt-30 page-title">Setting</h2>
									...
									<div class="card-body-table">
										<div class="news-content-right pd-20">
											<div class="form-group">
												...
												<input type="text" class="form-control" placeholder="mail.host.com">
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												<label class="form-label">SMTP Encryption (tls/ssl)*</label>
												<input type="text" class="form-control" placeholder="tls">
											</div>
											<div class="form-group">
